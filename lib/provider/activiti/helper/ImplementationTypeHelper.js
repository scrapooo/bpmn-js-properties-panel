...
var extensionsElementHelper = require('../../../helper/ExtensionElementsHelper');
...
/**
 * Returns 'true' if the given element is 'activiti:EventListener'
 *
 * @param {djs.model.Base} element
 *
 * @return {boolean} a boolean value
 */
ImplementationTypeHelper.isEventListener = function(element) {
  return is(element, 'activiti:EventListener');
};
...
ImplementationTypeHelper.isListener = function(element) {
  return this.isTaskListener(element) || this.isExecutionListener(element) || this.isEventListener(element);
};
