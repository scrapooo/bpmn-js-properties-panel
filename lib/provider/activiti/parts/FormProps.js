...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  function getSelectedFormField(element, node) {
    ...
    var formProperties = getExtensionElements(bo, 'activiti:FormProperty') || [];
    return formProperties[selected.idx];
  }
  ...
  var formFieldsEntry = extensionElements(element, bpmnFactory, {
    ...
    removeExtensionElement: function(element, extensionElements, value, idx) {
      var commands = [];
      var properties =  getExtensionElements(getBusinessObject(element), 'activiti:FormProperty')||[];
      commands.push(removeEntry(getBusinessObject(element), element, properties[idx]));
      return commands;
    },
    getExtensionElements: function(element) {
      var bo = getBusinessObject(element);
      return getExtensionElements(bo, 'activiti:FormProperty');
    },
